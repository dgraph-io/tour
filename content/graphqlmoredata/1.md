...
[dataset about movies, directors and actors](https://github.com/dgraph-io/dgraph-benchmarks/blob/main/data/1million.rdf.gz). There's around one million triples in the dataset.

You could load this dataset into your Dgraph instance, but we've already done
that for you as part of the tutorial setup.
...
[larger dataset of movies](https://github.com/dgraph-io/dgraph-benchmarks/blob/main/data/1million.rdf.gz)
that contains around 230,000 actors and around 86,000 movies.

The movie dataset has been loaded into your local Dgraph instance with the schema
