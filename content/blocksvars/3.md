...
For example, consider the set of actors in all Jane Campion films. Which pairs
from that set have acted together in a film not directed by Jane Campion?
...
The query returns both trivial self-matches (an actor paired with themselves) and
genuine co-actor pairs.
